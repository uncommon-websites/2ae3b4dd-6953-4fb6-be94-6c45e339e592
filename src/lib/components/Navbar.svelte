...
<nav class="bg-black text-white py-4 px-6 flex items-center justify-between sticky top-0 z-50 border-b border-gray-900">
  <div class="flex items-center gap-8">
    <a href="/" class="text-2xl font-medium tracking-tight">Runway Safe</a>
    ...
    <div class="hidden md:flex items-center gap-6 text-[13px] font-medium text-gray-300">
      ...
      <a href="#installations" class="hover:text-white transition-colors">Installations</a>
      <a href="#about" class="hover:text-white transition-colors">About</a>
      <a href="#investors" class="hover:text-white transition-colors">Investors</a>
    </div>
  </div>
